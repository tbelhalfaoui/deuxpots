...
export const NumberBox = ( props ) => (
    <NumericFormat
        class={`form-control box ${((!props.value) && (props.value !== 0)) && 'invalidBox'}`}
        thousandSeparator=" "
        decimalScale={0}
            ...
            <div class="row">
                ...
                <div class="p-1 col-4 col-lg-3">
                    <div class="form-floating">
                        ...
                        <label for={`${box.code}.partner_0_value`}>Decl. 1</label>
                    </div>
                </div>
                <div class="p-1 col-4 col-lg-3">
                ...
                <div class="p-1 col-4 col-lg-3">
                    <div class="form-floating">
                        ...
                        <label for={`${box.code}.partner_1_value`}>Decl. 2</label>
                    </div>
                </div>
            </div>
        </div>
